...
#define REGION_PEN_COLOR RGB(153, 50, 204)
#define REGION_PEN_DRAW_COLOR RGB(135, 206, 250)
#define REGION_COLOR_BK RGB(176, 224, 230))
#define REGION_BLEND 90

#define FILE_FORMAT_NAME_PREFIX L"screenshot-"
